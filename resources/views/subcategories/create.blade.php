...
<div class="space-y-6">
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Create New Subcategory</h1>
        <p class="text-gray-600 mt-1">Fill out the form below to add a new subcategory.</p>
    </div>
    ...
    <form action="{{ route('subcategories.store') }}" method="POST">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="mt-6 flex justify-end">
                <a href="{{ route('subcategories.index') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg mr-2">Cancel</a>
                <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-lg">Create Subcategory</button>
            </div>
        </div>
    </form>
</div>
