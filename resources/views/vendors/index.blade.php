...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 mt-1">Manage your vendors and their details</p>
        </div>
        <a href="{{ route('vendors.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg inline-flex items-center">
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2">
                                        ...
                                        <form action="{{ route('vendors.destroy', $vendor) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="text-red-600 hover:text-red-900" onclick="return confirm('Are you sure you want to delete this vendor?')" title="Delete">
        ...
        @else
            <div class="px-6 py-12 text-center">
                ...
                <p class="mt-1 text-sm text-gray-500">Get started by creating your first vendor.</p>
                <div class="mt-6">
